...
const manifest=JSON.parse(fs.readFileSync('geometry/expansion/batch19/manifest.json'));
manifest.features=manifest.features.filter(f=>f.id==='way-809238788').map(f=>({...f,entry:f.estimated_front_entry}));
