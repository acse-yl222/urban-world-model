...
const manifest=JSON.parse(fs.readFileSync('geometry/expansion/batch17/manifest.json'));
manifest.features=manifest.features.filter(f=>f.id==='way-640097056').map(f=>({...f,entry:f.photo_front_entry}));
