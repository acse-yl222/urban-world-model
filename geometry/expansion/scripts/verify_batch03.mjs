...
fs.writeFileSync('geometry/expansion/batch03/reports/viewer_check.json',JSON.stringify({passed:true,total_buildings:results.reduce((a,b)=>a+b.ids.length,0),batches:results,scope:'Actual source GLB decode and Three.js loader/batching; no live browser screenshot'},null,2));
console.log(results);
